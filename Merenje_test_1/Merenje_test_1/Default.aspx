            ...
            <table style="width:100%; height: 299px;">
                ...
                <tr>
                    ...
                    <td style="width: 139px">
                        <asp:TextBox ID="NazivTextBox" runat="server" Width="155px"></asp:TextBox>
                    </td>
                    <td style="width: 79px">&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="modal-sm" style="width: 60px">&nbsp;</td>
                    <td style="width: 139px">
                        <asp:Button ID="SnimiButton" runat="server" Text="SNIMI" Width="155px" OnClick="SnimiButton_Click" style="margin-left: 3px" />
                    </td>
                    <td style="width: 79px">&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="modal-sm" style="width: 60px">&nbsp;</td>
                    <td style="width: 139px">
                        <asp:Label ID="Label1" runat="server" Text="Unesite naziv i oznaku države"></asp:Label>
                    </td>
                    <td style="width: 79px">&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
